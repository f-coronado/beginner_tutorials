...
{
  new (message_memory) cpp_pubsub::msg::Message(_init);
}

void Message_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cpp_pubsub::msg::Message *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Message_message_member_array[1] = {
  {
    ...
    offsetof(cpp_pubsub::msg::Message, response),  // bytes offset in struct
...
{
  return &::cpp_pubsub::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp_pubsub, msg, Message)() {
  return &::cpp_pubsub::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
