...
#include <stddef.h>
#include "cpp_pubsub/msg/detail/message__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  cpp_pubsub__msg__Message__init(message_memory);
}

void Message__rosidl_typesupport_introspection_c__Message_fini_function(void * message_memory)
{
  cpp_pubsub__msg__Message__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Message__rosidl_typesupport_introspection_c__Message_message_member_array[1] = {
  {
    "response",  // name
    ...
    offsetof(cpp_pubsub__msg__Message, response),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Message__rosidl_typesupport_introspection_c__Message_message_members = {
  ...
  1,  // number of fields
  sizeof(cpp_pubsub__msg__Message),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cpp_pubsub, msg, Message)() {
