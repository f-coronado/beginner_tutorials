...
#include <stddef.h>
#include "cpp_pubsub/srv/detail/speak__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  cpp_pubsub__srv__Speak_Request__init(message_memory);
}

void Speak_Request__rosidl_typesupport_introspection_c__Speak_Request_fini_function(void * message_memory)
{
  cpp_pubsub__srv__Speak_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Speak_Request__rosidl_typesupport_introspection_c__Speak_Request_message_member_array[2] = {
  {
    "name",  // name
    ...
    offsetof(cpp_pubsub__srv__Speak_Request, name),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_pubsub__srv__Speak_Request, date),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Speak_Request__rosidl_typesupport_introspection_c__Speak_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(cpp_pubsub__srv__Speak_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cpp_pubsub, srv, Speak_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember Speak_Response__rosidl_typesupport_introspection_c__Speak_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_pubsub__srv__Speak_Response, output),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Speak_Response__rosidl_typesupport_introspection_c__Speak_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(cpp_pubsub__srv__Speak_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_cpp_pubsub
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cpp_pubsub, srv, Speak_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers cpp_pubsub__srv__detail__speak__rosidl_typesupport_introspection_c__Speak_service_members = {
  "cpp_pubsub__srv",  // service namespace
  "Speak",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // cpp_pubsub__srv__detail__speak__rosidl_typesupport_introspection_c__Speak_Request_message_type_support_handle,
  NULL  // response message
  // cpp_pubsub__srv__detail__speak__rosidl_typesupport_introspection_c__Speak_Response_message_type_support_handle
};

static rosidl_service_type_support_t cpp_pubsub__srv__detail__speak__rosidl_typesupport_introspection_c__Speak_service_type_support_handle = {
  0,
  &cpp_pubsub__srv__detail__speak__rosidl_typesupport_introspection_c__Speak_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cpp_pubsub, srv, Speak)() {
  if (!cpp_pubsub__srv__detail__speak__rosidl_typesupport_introspection_c__Speak_service_type_support_handle.typesupport_identifier) {
    cpp_pubsub__srv__detail__speak__rosidl_typesupport_introspection_c__Speak_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)cpp_pubsub__srv__detail__speak__rosidl_typesupport_introspection_c__Speak_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cpp_pubsub, srv, Speak_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cpp_pubsub, srv, Speak_Response)()->data;
  }

  return &cpp_pubsub__srv__detail__speak__rosidl_typesupport_introspection_c__Speak_service_type_support_handle;
}
