...
class Metaclass_Speak(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cpp_pubsub.srv import _speak
...
class Speak(metaclass=Metaclass_Speak):
    from cpp_pubsub.srv._speak import Speak_Request as Request
    from cpp_pubsub.srv._speak import Speak_Response as Response
