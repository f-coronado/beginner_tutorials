...
#include "cpp_pubsub/msg/detail/message__rosidl_typesupport_fastrtps_c.h"
...
using _Message__ros_msg_type = cpp_pubsub__msg__Message;
...
size_t get_serialized_size_cpp_pubsub__msg__Message(
  const void * untyped_ros_message,
...
static uint32_t _Message__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cpp_pubsub__msg__Message(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_pubsub
size_t max_serialized_size_cpp_pubsub__msg__Message(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cpp_pubsub__msg__Message(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cpp_pubsub, msg, Message)() {
